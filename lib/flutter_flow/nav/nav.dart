...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CadastreseWidget.routeName,
          path: CadastreseWidget.routePath,
          builder: (context, params) => CadastreseWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            name: PaginadeperfilWidget.routeName,
            path: PaginadeperfilWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'Paginadeperfil')
                : NavBarPage(
                    initialPage: 'Paginadeperfil',
                    page: PaginadeperfilWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
          name: AlteraremailWidget.routeName,
          path: AlteraremailWidget.routePath,
          builder: (context, params) => AlteraremailWidget(),
        ),
        FFRoute(
          name: AlterarsenhaupWidget.routeName,
